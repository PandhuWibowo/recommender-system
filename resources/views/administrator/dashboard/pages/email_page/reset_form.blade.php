	...
	<div class="error-pagewrap">
		<div class="error-page-int">
            ...
            <div class="panel-body poss-recover">
              ...
              @endif
                <form action="{{ url('user/pages/forgot/password/resets') }}" id="loginForm" method="POST">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                    <div class="form-group">
                        <label class="control-label" for="username">Email</label>
                        <input type="hidden" name="id" required="" value="{{ Crypt::encrypt($user->id)}}" readonly class="form-control">
                        <input type="hidden" name="code_reset_password" required="" value="{{ Crypt::encrypt($id)}}" readonly class="form-control">
                        <input type="email" name="email" placeholder="example@gmail.com" title="Please enter you email adress" required="" value="{{ $user->email}}" readonly class="form-control">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="username">Confirmation Password</label>
                        <input type="password" name="confirm_password" placeholder="New Password" required="" class="form-control">
                    </div>
