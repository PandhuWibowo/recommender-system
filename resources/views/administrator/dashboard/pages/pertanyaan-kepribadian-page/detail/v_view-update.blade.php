                                          ...
                                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              <div class="chosen-select-single mg-b-20">
                                                  ...
                                                  <select data-placeholder="Choose Assesment Type" id="assesment_id" name="assesment_id" class="chosen-select" tabindex="-1">
                                                      ...
                                                      <option value="{{Crypt::encrypt($row->id)}}" <?php echo ($editSoal->assessment_id == $row->id) ? "selected" : "";?>>{{$row->nama}}</option>
                                                    @endforeach
												  												</select>
                                              </div>
                                              ...
                                              <div class="after-add-more type_answer">
																								@foreach($editSoal->getJawabans as $key=>$valJawaban)
																									<div class="chosen-select-single mg-b-20">
		                                                ...
		                                                <select style="width:100%;" id="kepribadian_id" name="kepribadian_id[]" class="kepribadian_id form-control">
																											...
																											@foreach($jenisKepByAssId as $valJAss)
																												<option value="{{Crypt::encrypt($valJAss->id)}}" <?php echo ($valJAss->id == $valJawaban->kepribadian_id) ? "selected" : "";?>>{{$valJAss->nama}} - {{$valJAss->kode_nama}}</option>
																											@endforeach
																										</select>
		                                            	</div>
																									...
																									<div class="chosen-select-single mg-b-20">
	                                                    <label>Answer</label>
	                                                    <textarea class="form-control" rows="5" id="opsi_jawaban" name="opsi_jawaban[]" style="height: 150px;" name="answer" placeholder="Answer">{{$valJawaban->opsi_jawaban}}</textarea>
	                                                </div>
