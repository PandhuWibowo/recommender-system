...
<body>
                                      ...
                                      <tbody>
                                        @foreach($dataPenjelasanTypes as $key => $row)
                                          <tr>
                                            ...
                                            <td>
                                                <?php
                                                  $words = explode(" ", $row->penjelasan_tipe_2);
                                                  echo implode(" ", array_splice($words, 0, 5));
                                                 ?>
                                            </td>
                                            <td>
                                      ...
                                      <div class="modal-dialog modal-lg">
                                        ...
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">New Detail Type</h4>
                                          </div>
                                          <div class="modal-body">
                                            <div class="form-group">
                                              <label for="usr">Typical Scale Type</label>
                                              <!-- <input type="text" class="form-control" autofocus="on" autocomplete="off" id="jenis_assesments" required> -->
                                              <select id="kepribadian_id" name="kepribadian_id" class="chosen-select" tabindex="-1">
                                                  <option value=""></option>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <!-- <input type="text" class="form-control" autofocus="on" autocomplete="off" id="jenis_assesments" required> -->
                                              <select id="tipe_id" name="tipe_id" class="chosen-select" tabindex="-1">
                                                  <option value=""></option>
                                            ...
                                            <div class="form-group res-mg-t-15">
                                              ...
                                              <textarea name="penjelasan_tipe_1" id="penjelasan_tipe_1" placeholder="Description Type 1"></textarea>
                                            </div>
                                            <div class="form-group res-mg-t-15">
                                              <label for="usr">Description Type 2</label>
                                              <textarea name="penjelasan_tipe_2" id="penjelasan_tipe_2" placeholder="Description Type 2"></textarea>
                                            </div>
                                          </div>
                                    ...
                                    <div id="editModal" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">Edit Detail Type</h4>
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="form-group res-mg-t-15">
                                              <label for="usr">Description Type 1</label>
                                              <textarea name="edit_penjelasan_tipe_1" id="edit_penjelasan_tipe_1" placeholder="Description Type 1"></textarea>
                                            </div>
                                            <div class="form-group res-mg-t-15">
                                              <label for="usr">Description Type 2</label>
                                              <textarea name="edit_penjelasan_tipe_2" id="edit_penjelasan_tipe_2" placeholder="Description Type 2"></textarea>
                                            </div>
                                          </div>
                                          <div class="modal-footer">
    ...
    <script>
      //Buat Insert Modal
      CKEDITOR.replace( 'penjelasan_tipe_1' );
      CKEDITOR.replace( 'penjelasan_tipe_2' );

      CKEDITOR.replace( 'edit_penjelasan_tipe_1' );
      CKEDITOR.replace( 'edit_penjelasan_tipe_2' );

      $("#kepribadian_id").select2({
        placeholder: "Choose The Typical Scale Type",
        width:  '100%'
      });
      ...
      $("#edit_kepribadian_id").select2({
        placeholder: "Choose The Typical Scale Type",
        width:  '100%'
      });

      $("#edit_tipe_id").select2({
        placeholder: "Choose The Type",
        width:  '100%'
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#myAssesments").on("click", ".btn_edit",function(){
          ...
          var varTipeId             = $(this).data("tipe_id");
          var varPenjelasanTipe1    = $(this).data("penjelasan_tipe_1");
          var varPenjelasanTipe2    = $(this).data("penjelasan_tipe_2");
          try {
            $("#edit_id").val(varId);
            $("#edit_kepribadian_id").val(varKepribadianId).trigger("change");
            $("#edit_tipe_id").val(varTipeId).trigger("change");
            CKEDITOR.instances['edit_penjelasan_tipe_1'].setData(varPenjelasanTipe1);
            CKEDITOR.instances['edit_penjelasan_tipe_2'].setData(varPenjelasanTipe2);
        ...
        $("#btn_save").on("click", function(){
          ...
          var varKepribadianId  = $("#kepribadian_id").val();
          var varTipeId         = $("#tipe_id").val();
          var varPenjelasanTipe1    = CKEDITOR.instances["penjelasan_tipe_1"].getData();
          var varPenjelasanTipe2    = CKEDITOR.instances["penjelasan_tipe_2"].getData();
          ...
          try {
            if(varKepribadianId == ""){
              swal({
                type    : "info",
                title   : "Empty",
                text    : "Typical Scale Type is required",
                timer   : 3000
              });
            }
            else if(varTipeId == ""){
              ...
              $.ajax({
                type    : "POST",
                url     : "{{ url('backend/pages/model/types') }}",
                async   : true,
                dataType: "JSON",
                data    : {
