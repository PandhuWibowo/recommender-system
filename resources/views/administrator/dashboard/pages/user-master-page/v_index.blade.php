                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                          <a href="{{ url('backend/pages/users/add') }}" class="btn btn-primary">
                                            Add New
                                          </a>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                ...
                                                <div class="alert alert-warning alert-st-three" role="alert">
                                                    ...
                                                    <p class="message-mg-rt"><strong>Not Active</strong></p>
                                                </div>
                                                @elseif($row->active == 1)
                                                <div class="alert alert-success alert-st-one" role="alert">
                                                    <i class="fa fa-check edu-checked-pro admin-check-pro" aria-hidden="true"></i>
                                                    <p class="message-mg-rt"><strong>Activated</strong></p>
                                                </div>
                                                @else
                                                  <div class="alert alert-danger alert-mg-b alert-st-four" role="alert">
                                                      ...
                                                      <p class="message-mg-rt"><strong>Disabled/Block</strong></p>
                                                  </div>
                                                @endif
                                              </td>
                                              <td>
                                                  <a href="{{ url('backend/pages/users/'.Crypt::encrypt($row->id))}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                              </td>
                                            </tr>
                                          @endforeach
                                      </tbody>
