                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                ...
                                <div class="product-tab-list tab-pane fade" id="INFORMATION">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form class="" action="{{ url('backend/pages/users/update') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                  {{ csrf_field() }}
                                                  {{ method_field('PUT') }}
                                                  <div class="row">
                                                      <div class="col-lg-6">
      ...
      try {
        swal({
          ...
          if(result.value){
            $.ajax({
              type      : "DELETE",
              url       : "{{ url('backend/pages/users/delete') }}",
              async     : true,
              dataType  : "JSON",
              data      : {
                id      : varId
              ...
              success:function(data){
                ...
                if(data.response == "success"){
                  swal(
                    ...
                    window.location = "{{ url('backend/pages/users') }}";
                  });
                }
              },
              error:function(data){
