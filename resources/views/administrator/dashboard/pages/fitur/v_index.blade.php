                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Features</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                          ...
                                          <tr>
                                            ...
                                            <td align="center">
                                              <?php
                                                if($row->image == ""){
                                                  ?>
                                                    <img id="myImg" class="img-responsive myImg" width="50%" src="https://extension.illinois.edu/stain/stains-hi/235.jpg" alt="unknown" />
                                                  <?php
                                                }else{
                                                  ?>
                                                    <img id="myImg" class="img-responsive myImg" width="50%" src="{!! asset('images/images-feature/'.$row->image) !!}" alt="{{$row->image}}" />
                                                  <?php
                                                }
                                              ?>
                                            </td>
                                            ...
                                            <td>
                                              <?php
                                                $words = explode(" ", ucfirst($row->description));
                                                echo implode(" ", array_splice($words, 0, 7));
                                               ?>
                                            </td>
                                            <td>
                                                <!-- <a class="btn btn-warning btn_view" data-id="{{Crypt::encrypt($row->id)}}" data-image="{{ $row->image }}" data-title="{{ ucfirst($row->title) }}" data-description="{{ucfirst($row->description)}}"><i class="fa fa-eye"></i></a> -->
                                                <a class="btn btn-info btnEdit" data-id="{{Crypt::encrypt($row->id)}}" data-image="{{ $row->image }}" data-title="{{ ucfirst($row->title) }}" data-description="{{ucfirst($row->description)}}"><i class="fa fa-edit"></i></a>
                                           ...
                                           <form class="" action="{{ url('backend/pages/features/store') }}" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="description" style="height: 150px;" name="description" placeholder="Description"></textarea>
                                                </div>
                                   ...
                                   <div id="modalEdit" class="modal fade" role="dialog">
                                    <div class="modal-dialog modal-lg">
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <form class="" autocomplete="off" action="{{ url('backend/pages/features/update') }}" method="POST" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                          {{ method_field('PUT') }}
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <div class="form-group">
                                                  <label for="agency">Title</label>
                                                  <input type="text" class="form-control" name="edit_title" id="edit_title" value="">
                                              </div>

                                              <div class="form-group">
                                                <label for="opini">Description</label>
                                                <textarea class="form-control" style="height:40%;" id="edit_description" name="edit_description"></textarea>
                                              </div>
          ...
          try {
            swal({
              ...
              if(result.value){
                $.ajax({
                  type      : "DELETE",
                  url       : "{{ url('backend/pages/features/delete') }}",
                  async     : true,
                  dataType  : "JSON",
                  data      : {
                    id      : varId
                  ...
                  success:function(data){
                    ...
                    if(data.response == "success"){
                      swal(
                        ...
                        window.location = "{{ url('backend/pages/features') }}";
                      });
                    }
                  },
                  error:function(data){
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#myCompetencies").on("click", ".btnEdit",function(){
          var varId         = $(this).data("id");
          var varImage      = $(this).data("image");
          var varTitle      = $(this).data("title");
          var varDescription= $(this).data("description");
          // console.log(varTestiName);
          // $("#edit_nama_testi").val(varTestiName).trigger("change");
          $("#edit_title").val(varTitle);
          $("#edit_description").val(varDescription);
          $("#edit_id").val(varId);
