                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Users Profile</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                @if($dataUsers->image != "")
                                  ...
                                  <img src="{!! asset('images/images-users/'.$dataUsers->image) !!}" alt="{{$dataUsers->image}}" />
                                @else
                                  <img src="{!! asset('assets/assets_admin/img/profile/pp.png') !!}" alt="{{$dataUsers->image}}" />
                                @endif
                            </div>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                          <div class="address-hr">
                                              <p><b>Full Name</b><br />
                                                @if($dataUsers->firstname != "" && $dataUsers->lastname != "")
                                      ...
                                      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                          <div class="address-hr">
                                              <p><b>Email Account</b><br />
                                                @if($dataUsers->email != "" && $dataUsers->active == 1)
                                                  {{$dataUsers->email}}
                                                @elseif($dataUsers->email != "" && $dataUsers->active == 0)
                                  ...
                                  <div class="row">
                                      <div class="col-lg-12">
                                          <div class="address-hr">
                                              ...
                                              <button id="btn_delete" data-id="{{Crypt::encrypt($dataUsers->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                          </div>
                                      </div>
                                  </div>
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                            ...
                                            <div class="review-content-section">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="ex-pro">
                                                          @if($dataUsers->created_at != "")
                                                            {{Carbon::parse($dataUsers->created_at)->formatLocalized('%A, %d %B %Y')}} - {{$dataUsers->created_at->diffForHumans()}}
                                                          @else
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="ex-pro">
                                                          @if($dataUsers->active != "")
                                                            Active
                                                          @else
                                                            <span class="badge"><i class="fa fa-exclamation"></i> Not Active</span>
                                                          @endif
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="product-tab-list tab-pane fade" id="INFORMATION">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form class="" action="{{ url('user/pages/profiles/update') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                  {{ csrf_field() }}
                                                  {{ method_field('PUT') }}
                                                  <div class="row">
                                                      <div class="col-lg-6">
                                                          <div class="form-group">
                                                              <input name="id_admin" type="hidden" readonly class="form-control" placeholder="Id" value="{{Crypt::encrypt($dataUsers->id)}}">
                                                          </div>
                                                          <div class="form-group">
                                                              <input name="first_name" type="text" class="form-control" placeholder="First Name" value="{{$dataUsers->firstname}}">
                                                          </div>
                                                          <div class="form-group">
                                                              <input name="last_name" type="text" class="form-control" placeholder="Last Name" value="{{$dataUsers->lastname}}">
                                                          </div>
                                                          <div class="form-group">
                                                              <input name="nick_name" type="text" class="form-control" placeholder="Nick Name" value="{{$dataUsers->nickname}}">
                                                          </div>
                                                          <div class="form-group">
                                                              <input name="address" type="text" class="form-control" placeholder="Address" value="{{$dataUsers->address}}">
                                                          </div>
                                                      </div>
                                                      <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input name="email" type="email" class="form-control" placeholder="Email" value="{{$dataUsers->email}}" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="username" type="text" class="form-control" placeholder="Username" value="{{$dataUsers->username}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="phone" type="text" class="form-control" placeholder="Phone" value="{{$dataUsers->phone}}">
                                                        </div>
                                                        <div class="form-group">
                                                          <input name="level" type="text" class="form-control" placeholder="Level" value="{{$dataUsers->level}}" readonly>
                                                        </div>
                                                        <div class="file-upload-inner ts-forms">
                                                            <div class="input prepend-big-btn">
                                                                ...
                                                                <input type="text" id="prepend-big-btn" placeholder="no file selected" value="{{$dataUsers->image}}">
                                                            </div>
                                                        </div>
                                                      </div>
                                                  </div>
      ...
      try {
        swal({
          ...
          if(result.value){
            $.ajax({
              type      : "DELETE",
              url       : "{{ url('user/pages/profiles/delete') }}",
              async     : true,
              dataType  : "JSON",
              data      : {
                id      : varId
              ...
              success:function(data){
                ...
                if(data.response == "success"){
                  swal(
                    ...
                    window.location = "{{ url('backend/pages/signout') }}";
                  });
                }
              },
              error:function(data){
